...
import '../../../controller/auth/signUpAsProviderController.dart';
import '../../widgets/auth/customTextFormField.dart';

class SignUpAsProvider extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: WillPopScope(
        ...
        child: GetBuilder<SinUpAsProviderControllerImp>(
          builder: (controller) =>
                        ...
                        child: ListView(
                          children: [
                            ...
                            CustomTextFormField(
                              isNumber: false,
                              valid: (val) {
                                return validInput(val!, 2, 20, "phone");
                              },
                            ...
                            CustomTextFormField(
                              isNumber: false,
                              valid: (val) {
                                return validInput(val!, 2, 20, "OTP");
                              },
