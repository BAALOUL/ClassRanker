import 'package:classRanker/controller/students/getStudentsByClassController.dart';
...
class SelectClass extends GetView<GetStudentsByClassControllerImp> {
  const SelectClass({super.key});

  @override
  Widget build(BuildContext context) {
    Get.put(GetStudentsByClassControllerImp());
    return SizedBox(
      width: 160,
      height: 45,
